...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/crm/crmContract/form?id=${crmContract.id}">合同<shiro:hasPermission
            name="crm:crmContract:edit">${not empty crmContract.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
            name="crm:crmContract:edit">查看</shiro:lacksPermission></a></li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="crmContract" action="${ctx}/crm/crmContract/save" method="post"
    ...
    <div class="control-group">
        <label class="control-label">机会：</label>
        <div class="controls">
            <form:input path="crmChance.id" htmlEscape="false" maxlength="200" class="input-xlarge "/>
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:select path="paymentMethod" class="input-xlarge ">
                ...
                <form:options items="${fns:getDictList('crm_contract_payment_method')}" itemLabel="label"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <sys:treeselect id="sysUser" name="sysUser.id" value="${crmContract.sysUser.id}" labelName="sysUser.name"
                            labelValue="${crmContract.sysUser.name}"
    ...
    <div class="form-actions">
        <shiro:hasPermission name="crm:crmContract:edit"><input id="btnSubmit" class="btn btn-primary" type="submit"
